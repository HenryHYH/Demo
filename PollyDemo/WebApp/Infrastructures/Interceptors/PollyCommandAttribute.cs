...
namespace WebApp.Infrastructures.Interceptors
{
    [AttributeUsage(AttributeTargets.Method)]
    public class PollyCommandAttribute : AbstractInterceptorAttribute
    {
        /// <summary>
        /// 最多重试几次，如果为0则不重试
        /// </summary>
        ...
        public PollyCommandAttribute(string fallBackMethod)
        {
