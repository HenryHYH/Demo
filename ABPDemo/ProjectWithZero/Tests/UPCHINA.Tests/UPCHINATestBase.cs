...
namespace UPCHINA.Tests
{
    public abstract class UPCHINATestBase : AbpIntegratedTestBase
    {
        ...
        protected void UsingDbContext(Action<UPCHINADbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Action<UPCHINADbContext> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<UPCHINADbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<UPCHINADbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<UPCHINADbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<UPCHINADbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<UPCHINADbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<UPCHINADbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<UPCHINADbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<UPCHINADbContext, Task<T>> func)
        {
            T result;
